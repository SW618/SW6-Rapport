...
As is evident from \myref{sec:sprintreview3} we did not finish completely finish the REST API user stories pertaining to Week Schedule and Sequence despite spending significantly more EP than we had allocated.
...
This is based on the general knowledge we have gained in regards to developing the REST API, as well as having a fully defined design, as well as two already implemented and tested layers.%*Salute* General Knowledge!
