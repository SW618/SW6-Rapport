...
\end{figure}\todo{Screenshottet er på dansk, skal vi oversætte det ?}

\subsubsection{Implementation of Internet Connection Check}
To easily enable other parts of GIRAF to check if a connection to the internet is available, we implement the check in the \texttt{giraf-component} library as seen in \myref{lst:networkutil}.
