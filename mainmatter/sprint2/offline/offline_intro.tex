...
Alongside making the launcher work offline, changes to the Week Schedule is needed, alongside, alongside policies on how possible conflicts between server-- and client--side versions should be handled, e.g. a user does some work offline while another does some work online. \todo{Too many \enquote{alongside}?}
