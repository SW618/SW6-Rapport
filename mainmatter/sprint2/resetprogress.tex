...
As the button has been now been\kim{to much ``been''} used in both guardian and citizen views the functionality has also been moved to the view which the \texttt{ScheduleView} inherits from such that it can easily be added back if needed. \kim{didn't you just remove the functionality from the citizen? I dont follow the logic.}
