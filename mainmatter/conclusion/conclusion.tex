...
We used parts of Scrum throughout the project, in the start for the first two sprints we had somewhat neglected it for various reasons, but started using it more in sprint three and four. \kim{Try to explain some of the reasons why you did not think it was useful to use scrum in the start.}
...
\kim{Det er fint at slutte kapitlet på denne måde.}