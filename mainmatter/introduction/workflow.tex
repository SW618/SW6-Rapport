...
Groups take on\kim{instead of take on, then write add to their sprint backlog.} user stories at the sprint planning meeting, but can also remove or add more during the sprint as needed. \kim{If you can just add and remove as you want, why would you even have a sprint backlog. Why not just take a new task when you are done with the privious one? (Dette er skrevet i en provokerende tone der skal få jer til at tænke over problemstillingen).}
...
\kim{This paragraph have become quite confusing because it mixes the explanation if the workflow with the discussion of it. Try to seperate it.}
