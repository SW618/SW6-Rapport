...
\kim{What a cumbersom way to say that some apps are required. I dont understand what you mean by ``only requires this set''}
This is due to the applications\kim{I dont understand what ``this'' refers to.} having originally been developed by different groups as individual small applications, rather than a collaborative work, this includes the launcher and administrative tools.
...
\kim{Maybe add a lines that says that you will now explain each of the 11 apps.}
\begin{description}
	...
	Life Story (also known as ``Livshistorier'' in Danish) is similar to the Sequence application but is used to remember what actions were taken by a citizen throughout the day, or as a way of communicating since some citizens have a lot of trouble with their verbal communication. \kim{It does not seem clear what this app do.}
