...
\kim{Scrum of Scrum er altid med stort. Ligeledes er Scrum også med stort begyndelses bogstav.}
...
This is changed for the multi-project of 2016, as many of the reports from last year recommended this change, such that any group would be able to work on any tasks which occur during the project. \kim{Nummer to sætning er mærkelig, der står "this change" men i har ikke nævnt hvad ændringen er. Kunne det ske at der skulle havde stået "to change this".?}
...
\begin{description}
	...
	\kim{This section explains a lot of different things. Consider splitting it. It contains task estimation, and user stories/tasks. In addition, it could use a rewrite due to repetitions and the mixing of topics. e.g. ", and can develop throughout development, more tasks can be added throughout the project".}
	...
	\kim{Then what do you do if you run out of tasks? vacation? ;)}
	...
	\kim{En mindre ting som i skal være opmærksomme på er om i skriver Amerikansk engelsk eller britisk engelsk. Hedder der organising eller organizing. prioritise eller prioritize. I skal bare være konsistente.}
	...
	\kim{I am interested in how you prioritize tasks}
	...
	\kim{Pictures or it didn't happen.}
\end{description}
\kim{Det er ikke klart for mig hvordan i estimere jeres tasks.}
...
\kim{Footnote should be before the dot.}
...
\kim{Very good. I love to hear/read about why you designed your process the way you do. More of this please. :D}
...
\begin{description}
	...
	\kim{Try to be more precise. It could be misunderstood in a number of different ways.}
	This means that the multi-project has a single product backlog for the multi-project, which is where all tasks come from.
	\kim{I can imagine a number of problems related to this approach (I am not saying it is a bad way to do it), what if two groups want the same tasks? How do you ensure that the high priority tasks are chosen? How do you know how many tasks you need to choose if you do not estimate them before hand?}
	\item[Sprint Retrospective] \hfill \\
	The sprint retrospective has the job of reviewing and improving the development process. 
	\kim{Prøv at lade være med at give ting og koncepter menneskelige egenskraber. sprint retrospective kan fx ikke have en "job". Det er ikke det første sted jeg har mødt det, det er en mindre ting men nu ved i det :) }
...
\todo[inline]{Vi har også et git workflow og en review process af kode som ikke er skrevet om. Der er en guide om dette på wiki, Skal vi forklare det meget ud i detalje, eller blot ridse det op hurtigt, og have en guide i appendix evt? - Søren}
\kim{Hvis det er relevant for jer og det ansvarsområde som i arbejder ja. Ellers ikke. }