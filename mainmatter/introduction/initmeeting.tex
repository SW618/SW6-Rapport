...
\begin{description}
	...
	Across the multi-project we have decided upon the form of a user story to be: ``As a <type of user>, I want <some goal> so that <some reason>''.
	...
	Each sprint will also have a number of EP, and the sum of EP in the stories should be close to the number of EP for the sprint. 
	...
	Otherwise each group member should tell the others why they think they have estimated correctly, and then the process starts over untill an agreement have been met.
