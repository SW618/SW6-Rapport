...
In the book \textit{Agile Software Development with Scrum} Ken Schwaber argues that Scrum \enquote{... enables people to work together effectively, and by doing so, it enables them to produce complex, sophisticated products}\myref{scrumbookschwaber}.
