...
\begin{description}
	...
	\kim{It is fine. A minor thing is that the relationshop between a task and a user story is still not clear. I still do not like the ``Unbreak Now!'', it sounds to informal.}
	...
	\kim{Incorrect English. I think you inted to write ``until an agreement is reached.''}
