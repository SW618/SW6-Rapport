At the start of this sprint we attend the Sprint Planning Meeting, where we assign us to tasks\kim{this sentence is not very good. ``Assign'' is normally used when a 3ed party is given a task. Try to represe. }, which we afterwards estimate according to the time it takes to complete them.
