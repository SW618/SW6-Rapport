At the start of this sprint we attend the Sprint Planning Meeting where we claim tasks that we want to resolve, which we afterwards estimate according to the time it takes to complete them.
...
\begin{description}[style=unboxed]
    ...
    \item[{[}\phigh{]} Pictosearch --- Responsive Search] \hfill \\
        \userstory{As a User I would like the Pictosearch application to feel more responsive when I search for pictograms, such that I don't feel like nothing happens when I type in the search field}
...
\begin{description}
    ...
    \item[{[}\phigh{]} Week Schedule --- Missing borders on pictograms] \hfill \\
        \userstory{As a citizen I would like the pictograms to have borders, such that I can distinguish the pictograms from each other, on any background color.}
