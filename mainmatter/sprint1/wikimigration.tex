\section{Wiki Migration}
\kim{This section is weak in the sense that no ``method'' was used, the task does not seem difficult. It is okay to have such sections, but dont have to many of these kinds of weak sections. In other words the task solved is trivial. If you want to make the section better then try to find some literature that describe information sharing or information migration and apply some of the contect that these sources describe. }
\todo[inline]{This will be reworked.}
