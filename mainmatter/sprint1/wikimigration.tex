...
On the Redmine wiki there are a lot of useful information, some of it might be outdated, but most are still useful and should be kept. 
...
Most of the contents on the wiki are guides which helps the developers with various tasks. 
These should be easy to navigate and have titles which clearly encompass their purpose and contents. 
...
Therefore we have in addition to the initial migration, we have setup e-mail alerts in Phabricator such that we get a notification every time someone changes the wiki.
...
\unsure[inline]{We have not written in any detail about the conversion of Redmine markup format to Phabricators, which was much of the timesink in this initial conversion. It's quite simple, but was a bit time consuming. Should this be documented? - Troels}