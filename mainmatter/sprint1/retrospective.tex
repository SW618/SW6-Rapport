...
During our programming session we found much use in pair programming as it helped solve issue quickly. 
Often one person would have an answer to a problem that the other person didn't know, and this helped getting though obstacles quickly. 
This is especially true since none of us have had any previous experience with developing for Android before, and thusly there is a lot of new knowledge to gain. 
For this reason we will attempt to continue with pair programming for the next sprint. 
