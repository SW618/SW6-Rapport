...
\subsection{Gradle}
During the debugging of the issue, which caused us not being able to build libraries, explained in \myref{sec:breaking}, we gained a lot of insight into how the Gradle build system works, and how the Giraf libaries and applications are connected internally. 
