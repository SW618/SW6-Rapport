...
Firstly\kim{Det er første gang jeg har set nogle bruge ordet firstly, godt gået ;)} we will provide a general overview of tasks and the EP estimated in comparison to EP spent, as well as a brief explanation of the discrepancies between the two.
...
\kim{Why are some of the words in italic? If Informal tasks is highlighted why isn't Formal tasks?}
