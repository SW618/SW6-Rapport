...
Actually, the query which results in the largest amount of pictograms is a search for the character \enquote{s}, it returns X pictograms and takes approximately X seconds on the relatively slow Lenovo tablet provided by the University. 
