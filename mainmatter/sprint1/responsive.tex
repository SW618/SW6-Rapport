...
The current version\todo{Er det forvirende at skrive current version når det er en kontinuer historie? Er det klart at der menes den udgave lavet af de tidligere GIRAF projekter? - Troels} of the PictoSearch application searches whenever the uses touches the search button on either the keyboard or on the GUI of the application.
