...
\begin{description}
	...
	If a class has a many-to-many relationship with another class and this relationship-table needs to contain additional information, e.g. an index for the relationship, a table that includes the index needs to be created as well.\todo{Skal alle many-to-many ikke manuelt have et table? - Troels}
