...
\begin{description}
    ...
    As such conflicts, as defined in \myref{ssec:policy}, are less likely to occur as the changes have to be targeted on the same Weekdays and not simply the WeekSchedule. 
...
As mentioned in \myref{sec:generalEP}
\todo[inline]{SQL}
