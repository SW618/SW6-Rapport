...
If we refer to the object that it identifies in the real world it will be written in standard language grammar with our normal font, e.g. week schedule.\todo{Skal det ikke rykkes til noget forord/reading guide?} \kim{Jo, flyt det til reading guide.}
