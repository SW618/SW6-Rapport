...
\end{center}
This section is written to document the completed core and persistence layer of the week schedule REST API, however some corrections were implemented after sprint end as the review process depended on another group which ended up delaying us, see more in \myref{sec:sprintreview3}.
