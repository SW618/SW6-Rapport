...
\end{lstlisting}
\caption{Fields with annotations which causes Hibernate to perform the ORM for \texttt{titlePictogram}. \texttt{[...]} denotes omitted code.}\label{lst:titlePictogram}
\end{figure}
