...
\subsubsection*{Frame}
	\begin{description}
		...
		\item[partofSequences] This is a collection of sequences this frame is used in; why this collection is needed will be further explained in \myref{sec:sequence}.
	\end{description}
