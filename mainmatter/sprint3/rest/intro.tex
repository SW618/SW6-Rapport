In this chapter we will explain the motivations for creating the REST API, as well as our reasoning for the decisions in regards to the design and implementations of the REST API for the GIRAF project.
