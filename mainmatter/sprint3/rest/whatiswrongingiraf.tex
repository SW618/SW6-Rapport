...
During last semester one of the project groups, SW610F15, attempted to set--up SymmetricDS\footnote{More details at: \url{http://www.symmetricds.org/}} to synchronise the remote- and local--databases.
