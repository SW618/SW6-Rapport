\section{Architechture of the REST API}\label{architechture}
Before developing the code which creates the API endpoints, a proper architecture should be established.
Since it can be costly to backtrace\todo{Måske ikke det bedste ord?} and change central decisions made in this phase, a big amount of time have been spent thinking about the design.
