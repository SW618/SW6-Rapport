...
\kim{I dont understand why you have this section, and why is it under the REST API chapter? I get that this is technologies that you use on the server, but I would say that rest is one of the technologies that you use, thus on equal level with sprint and java!}
...
\begin{description}
    ...
    \item[Hibernate] \hfill \\
        ...
        We use Java annotations to configure this mapping on a, per variable, and class base, this will be further explained later in \todo{ref her.}.
    ...
    \item[MariaDB] \hfill \\
        ...
        \kim{I think that MariaDB belongs in the tools section.}
\end{description}
\subsubsection{Tools}
\begin{description}
    \item[Gradle] \hfill \\
    ...
    \item[JUnit] \hfill \\
        ...
        \kim{I would say this is a technology.}
