...
\begin{description}
    \item[Java] \hfill \\
        ...
        Java is also a very popular language, it is number on i TIOBEs Index\footnote{\url{http://www.tiobe.com/tiobe_index}} as of writing this.  \kim{What? missing the actual rank.}
    ...
    \item[FlyWay] \hfill \\
        ...
        \todo[inline]{Forward compadability here?}        
