...
\begin{description}
    ...
    \item[Hibernate] \hfill \\
        ...
        We use Java annotations to configure this mapping on a, per variable, and class base, this will be showcased with examples when they are used in e.g. \myref{sec:pictogramendpoint}.
    ...
    \item[RESTEasy] \hfill \\
        ...
        Examples of these are: \texttt{@GET}, \texttt{@POST} and \texttt{@Produces}, these will be further explained when we use them in \myref{sec:pictogramendpoint}.
