\chapter{Sprint End}
\kim{Normally you have some text here, but not in this chapter. There are also a few other chapters where you dont, it would be a nice finish if all chapthers had this motivating/overview text.}
...
We spent a lot more time discussing the design of Week Schedule with the other groups, especially about how to solve the security aspects of GIRAF. \kim{More time than what? sentence is incomplete.}
...
As we did not finish two of the REST API user stories, we will continue on implementing these in the next and final sprint \kim{Try to say this in scrum terms, i am thinking in regards to your backlogs.}, but as described above it is only the Service layers that are missing, which does seem to be the smallest layer of the 3.
...
\kim{What will you change in the next sprint planning to insure that your estimation is better?}
...
This sprint we made sure to have a Scrum meeting daily within our group, and we also used the Scrum board at these meetings, which had been neglected in sprint 2. \kim{Please also explain why it was nessary to start having these meeting. What problem did these meetings solve?}
