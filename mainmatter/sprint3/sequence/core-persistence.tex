...
The \texttt{@JoinTable} annotation is much like the \texttt{@JoinColumn} as explained in \myref{pictogramendpoint}, but instead a table is created, which is given a name \texttt{Sequence__Frame}, and also two join columns \texttt{sequence_id} and \texttt{frame_id}.
