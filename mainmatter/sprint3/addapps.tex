...
\kim{and should  not start with a capital letter.}
\label{sec:add_and_remove_applications}
This section will solve the following user story which was prioritised as \pmedhigh~by the PO: \kim{In the sprint planning section it is set to high.}
