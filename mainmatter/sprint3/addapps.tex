...
By solving the problem using this pseudo application, there is a clear coherence between where the apps are viewed and where the apps are managed.
...
\end{enumberate*}
On line~\ref{lst:newboolyo} in~\myref{lst:modified_constructor} the boolean which enables the pseudo application --- by default it is disabled.
